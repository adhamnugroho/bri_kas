...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Apr 2023 pada 12.03
...
CREATE TABLE `kas` (
  `id_kas` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `kas` (`id_kas`, `total_kas`, `created_at`, `updated_at`) VALUES
(1, 0, NULL, NULL),
(4, 550000, '2022-11-02 09:38:31', '2022-11-02 09:38:31'),
(5, 1100000, '2022-11-02 10:54:44', '2022-11-05 01:28:39'),
(6, 1650000, '2022-11-02 16:16:42', '2022-11-02 16:16:42'),
(7, 2200000, '2022-11-02 16:19:24', '2022-11-02 16:19:24'),
(8, 2800000, '2022-11-02 16:20:53', '2022-11-02 16:20:53'),
(9, 3300000, '2022-11-04 08:10:07', '2022-11-05 01:28:39'),
(10, 3300000, '2022-11-05 01:43:23', '2022-11-05 01:43:43'),
(11, 3200000, '2022-11-05 02:56:16', '2022-11-06 08:47:17'),
(12, 3200000, '2022-11-05 05:29:33', '2022-11-05 07:49:36'),
(13, 3100000, '2022-11-05 07:58:09', '2022-11-05 07:58:09'),
(14, 3050000, '2022-11-05 08:00:28', '2022-11-06 08:47:17');
...
CREATE TABLE `kas_keluar` (
  `id_kas_keluar` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `kas_keluar` (`id_kas_keluar`, `jenis_pengeluaran`, `nominal`, `tanggal_keluar`, `user_id`, `kas_id`, `keterangan`, `created_at`, `updated_at`) VALUES
(1, 'Americano Coffee', 100000, '2022-11-05', 2, 11, 'Americano Coffee Warung', '2022-11-05 02:56:16', '2022-11-06 08:47:17'),
(2, 'Matabak Telor', 50000, '2022-11-03', 2, 12, 'Matabak Telor Bebek Betina', '2022-11-05 05:29:33', '2022-11-05 07:49:36'),
(3, 'Martabak Manis', 100000, '2022-11-01', 2, 13, 'Matabak Manis Sultan Pacenongan', '2022-11-05 07:58:09', '2022-11-05 07:58:09');
...
CREATE TABLE `kas_masuk` (
  `id_kas_masuk` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `kas_masuk` (`id_kas_masuk`, `jenis_pemasukan`, `nominal`, `tanggal_masuk`, `user_id`, `kas_id`, `keterangan`, `created_at`, `updated_at`) VALUES
(14, 'Bulan September', 550000, '2022-09-30', 3, 5, '-', '2022-11-02 10:54:44', '2022-11-05 01:28:39'),
(15, 'Bulan Agustus', 550000, '2022-08-31', 6, 6, '-', '2022-11-02 16:16:42', '2022-11-02 16:35:29'),
(16, 'Bulan Juli', 550000, '2022-07-31', 4, 7, '-', '2022-11-02 16:19:24', '2022-11-06 08:46:48'),
(17, 'Bulan Juni', 600000, '2022-06-30', 4, 8, '-', '2022-11-02 16:20:53', '2022-11-02 16:20:53'),
(18, 'Bulan April', 500000, '2022-04-30', 2, 9, 'Pemasukan pada bulan april', '2022-11-04 08:10:07', '2022-11-04 08:10:07');
...
(12, '2022_06_02_105808_create_kas_table', 1),
(13, '2022_10_22_154646_create_kas_masuks_table', 1),
(14, '2022_10_22_154720_create_kas_keluars_table', 1);
...
INSERT INTO `users` (`id`, `nama`, `username`, `email`, `password`, `no_telp`, `provinsi_id`, `kabupaten_id`, `status`, `alamat_lengkap`, `level_user`, `created_at`, `updated_at`) VALUES
(1, 'Admin', 'admin', 'admin@gmail.com', '$2y$10$EwKWVwt9iITeXRXNG0bFreCvqrTrWnV/7NPhWGvOgU7l66Gso1D2S', NULL, NULL, NULL, 'Aktif', 'Kota Mojokerto', 'Admin', NULL, NULL),
(2, 'Adham', 'adham', 'adhamnugroho9@gmail.com', '$2y$10$kr/inAPNLsMiL8YysjCLteKGMbzBVGt7CV.Py6iNjusJeqDWsDWRe', '081217879476', 35, 1115, 'Aktif', 'Kota Mojokerto, Cakarayam', 'Pengguna', NULL, NULL),
(3, 'Ferdy Sambo', 'sambo beriman', 'samboberiman@gmail.com', '$2y$10$PK5x80ic6rGYsTyD.JbXkO/YJI699KjtII0MrIg75ccr5CUkv2szK', '08127382783', 35, 3516, 'Aktif', 'Magelang', 'Pengguna', '2022-11-02 07:18:24', '2022-11-02 07:28:54'),
(4, 'Nyonya Puff', 'nyonya puff', 'nyonyapuff@gmail.com', '$2y$10$nkNsYAOq9xizvwwJ2ZqyReTsIjxOD0ol1gmA4W58dVaxwAXjBHuPO', '081276836893', 51, 5171, 'Non-Aktif', 'prajurit kulon', 'Pengguna', '2022-11-02 07:21:21', '2022-11-02 07:21:21'),
(5, 'SCP-517', 'scp-517', 'scp517@gmail.com', '$2y$10$u4N.aC3OvucqtNW9XyU96eda9eTlFUzdDQSfVd.sz7Jcz3W1G7.XC', '08127382783', 19, 1906, 'Non-Aktif', 'Prajurit Kulon', 'Pengguna', '2022-11-02 07:23:13', '2022-11-02 07:23:13'),
(6, 'SCP-196-ID', 'scp-196-id', 'scp196id@gmail.com', '$2y$10$fKY8HkZgO8QDp11TzL/DSOxxN0M0sVXMj9QyaB.ghXItdJqOSrjSm', '081276836893', 21, 2102, 'Non-Aktif', 'Pulorejo', 'Pengguna', '2022-11-02 07:25:22', '2022-11-02 07:25:22');
...
ALTER TABLE `kas_keluar`
  ...
  ADD KEY `kas_keluar_kas_id_foreign` (`kas_id`);
...
ALTER TABLE `kas_masuk`
  ...
  ADD KEY `kas_masuk_kas_id_foreign` (`kas_id`);
...
--
ALTER TABLE `kas`
  MODIFY `id_kas` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT untuk tabel `kas_keluar`
--
ALTER TABLE `kas_keluar`
  MODIFY `id_kas_keluar` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT untuk tabel `kas_masuk`
--
ALTER TABLE `kas_masuk`
  MODIFY `id_kas_masuk` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `kas_keluar`
  ADD CONSTRAINT `kas_keluar_kas_id_foreign` FOREIGN KEY (`kas_id`) REFERENCES `kas` (`id_kas`),
  ADD CONSTRAINT `kas_keluar_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Ketidakleluasaan untuk tabel `kas_masuk`
--
ALTER TABLE `kas_masuk`
  ADD CONSTRAINT `kas_masuk_kas_id_foreign` FOREIGN KEY (`kas_id`) REFERENCES `kas` (`id_kas`),
  ADD CONSTRAINT `kas_masuk_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
