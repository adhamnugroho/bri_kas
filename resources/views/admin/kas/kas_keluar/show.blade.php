                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="total_kas" class="text-danger">
                                        Saldo Setelah Manarik Uang
                                    </label>
                                    <input type="number" class="form-control" id="total_kas" name="total_kas"
                                        placeholder="Masukkan Total Kas"
                                        value="{{ old('total_kas') ? old('total_kas') : $kas_keluar->kas->total_kas }}"
                                        disabled>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="nama_penarik" id="nama_penarik" class="form-control" required disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="keterangan" id="keterangan" cols="30" rows="3" class="form-control"
                                        placeholder="Masukkan Keterangan" disabled>{{ old('keterangan') ? old('keterangan') : $kas_keluar->keterangan }}</textarea>
                                </div>
