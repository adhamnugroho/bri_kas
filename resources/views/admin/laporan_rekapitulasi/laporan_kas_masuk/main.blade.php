                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-end">
                                ...
                                <button type="submit" class="btn btn-primary ml-3 col-sm-1" onclick="cariDataKasMasuk()"
                                    id="tombol_cari">
...
@section('script')
    ...
    <script>
        ...
        function cariDataKasMasuk() {
            ...
            const hasil_route = route('laporanKasMasuk', {
                tanggal_awal,
                tanggal_akhir
            });
    ...
    <script>
        function print() {
            ...
            const hasil_route = route('laporanKasMasukPrint', {
                tanggal_awal,
                tanggal_akhir
            });
