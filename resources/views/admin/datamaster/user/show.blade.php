                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama" name="nama"
                                        placeholder="Masukkan Nama" value="{{ $users->nama }}" required disabled>
                                </div>
                                <div class="form-group">
                                    <label for="username">
                                    ...
                                    <input type="text" class="form-control" id="username" name="username"
                                        placeholder="Masukkan Username" value="{{ $users->username }}" required disabled>
                                </div>
                                <div class="form-group">
                                    <label for="email">
                                    ...
                                    <input type="text" class="form-control" id="email" name="email"
                                        placeholder="Masukkan Email" value="{{ $users->email }}" required disabled>
                                </div>
                                {{-- <div class="form-group">
                                        <label for="password">
                                        ...
                                        <input type="password" class="form-control" id="password" name="password"
                                            placeholder="Masukkan Password" value="{{ old('password') }}" required disabled>
                                    </div> --}}
                                <div class="form-group">
                                    <label for="no_telp">
                                    ...
                                    <input type="text" class="form-control" id="no_telp" name="no_telp"
                                        placeholder="Masukkan No. Telephone" value="{{ $users->no_telp }}" required
                                        disabled>
                                </div>
                                <div class="form-group">
                                    <label for="provinsi">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="kabupaten_id" id="kabupaten" class="form-control" required disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="alamat_lengkap" id="alamat_lengkap" cols="30" rows="3" class="form-control"
                                        placeholder="Masukkan Alamat Lengkap" disabled>{{ $users->alamat_lengkap }}</textarea>
                                </div>
